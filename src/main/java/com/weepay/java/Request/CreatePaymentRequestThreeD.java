...
public class CreatePaymentRequestThreeD extends BaseRequest {
    ...
    public String toString() {
        return new ToStringRequestBuilder(this).appendSuper(super.toString()).append("orderId", this.orderId)
                ...
                .append("cardHolderName", this.cardHolderName).append("cardNumber", this.cardNumber)
                .append("expireMonth", this.expireMonth).append("expireYear", this.expireYear)
                .append("cvcNumber", this.cvcNumber).append("description", this.description)
                .append("paymentGroup", this.paymentGroup).append("paymentSource", this.paymentSource)
                .append("paymentChannel", this.paymentChannel).append("preAuth", this.preAuth)
                .append("cardUserKey", this.cardUserKey).append("callBackUrl", this.callBackUrl)
                .append("callBackType", this.callBackType).append("customer", this.customer)
    ...
    public JSONObject getJsonObject() {
        ...
        data.put("callBackType", this.callBackType);
